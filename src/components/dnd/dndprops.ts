  ...
  public classes: Class[] = [
    ...
    },
    {
      ...
      features: [
        ...
        // Circle of the Land
        { id: 2, level: 2, text: 'Bonus Cantrip (p.68)' },
        { id: 3, level: 2, text: 'Natural Recovery (p.68)' },
        { id: 4, level: 6, text: 'Land\'s Stride (p.69)' },
        { id: 5, level: 10, text: 'Nature\'s Ward (p.69)' },
        { id: 6, level: 14, text: 'Nature\'s Sanctuary (p.69)' },
        // Circle of the Moon
        { id: 7, level: 2, text: 'Combat Wild Shape (p.69)' },
        { id: 8, level: 2, text: 'Circle Forms (p.69)' },
        { id: 9, level: 6, text: 'Circle Forms (p.69)', replaces: 8 },
        { id: 10, level: 6, text: 'Primal Strike (p.69)' },
        { id: 11, level: 10, text: 'Elemental Wild Shape (p.69)' },
        { id: 12, level: 14, text: 'Thousand Forms (p.69)' },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        // Champion
        { id: 10, level: 3, text: 'Improved Critical (p.72)' },
        { id: 11, level: 7, text: 'Remarkable Athlete (p.72)' },
        { id: 12, level: 10, text: 'Additional Fighting Style (p.73)' },
        { id: 13, level: 15, text: 'Superior Critical (p.73)' },
        { id: 14, level: 18, text: 'Survivor (p.73)' },
        // Battlemaster
        { id: 15, level: 3, text: 'Combat Superiority (d8) [  ][  ][  ][  ] (p.73)' },
        { id: 16, level: 10, text: 'Combat Superiority (d10) [  ][  ][  ][  ] (p.73)', replaces: 15 },
        { id: 17, level: 18, text: 'Combat Superiority (d12) [  ][  ][  ][  ] (p.73)', replaces: 16 },
        { id: 18, level: 3, text: 'Student of War (p.73)' },
        { id: 19, level: 7, text: 'Know your Enemy (p.73)' },
        { id: 20, level: 15, text: 'Relentless (p.74)' },
        // Eldritch Knight
        { id: 21, level: 3, text: 'Weapon Bond (p.75)' },
        { id: 22, level: 7, text: 'War Magic (p.75)' },
        { id: 23, level: 18, text: 'Improved War Magic (p.75)', replaces: 22 },
        { id: 24, level: 10, text: 'Eldritch Strike (p.75)' },
        { id: 25, level: 15, text: 'Arcane Charge (p.75)' },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { id: 19, level: 3, text: 'Open Hand Technique (p.79)' },
        { id: 20, level: 6, text: 'Wholeness of Body (p.79)' },
        { id: 21, level: 11, text: 'Tranquility (p.80)' },
        { id: 22, level: 17, text: 'Quivering Palm (p.80)' },
        // Way of Shadow
        { id: 23, level: 3, text: 'Shadow Arts (p.80)' },
        { id: 24, level: 6, text: 'Shadow Step (p.80)' },
        { id: 25, level: 11, text: 'Cloak of Shadows (p.80)' },
        { id: 26, level: 17, text: 'Opportunist (p.80)' },
        // Way of the Four Elements
        { id: 27, level: 3, text: 'Disciple of the Elements (p.80)' },
        { id: 28, level: 17, text: 'Breath of Winter (p.81)' },
        { id: 29, level: 6, text: 'Clench of the North Wind (p.81)' },
        { id: 30, level: 3, text: 'Elemental Attunement (p.81)' },
        { id: 31, level: 11, text: 'Eternal Mountain Defense (p.81)' },
        { id: 32, level: 3, text: 'Fangs of the Fire Snake (p.81)' },
        { id: 33, level: 3, text: 'Fist of Four Thunders (p.81)' },
        { id: 34, level: 3, text: 'Fist of Unbroken Air (p.81)' },
        { id: 35, level: 11, text: 'Flames of the Phoenix (p.81)' },
        { id: 36, level: 6, text: 'Gong of the Summit (p.81)' },
        { id: 37, level: 11, text: 'Mist Stance (p.81)' },
        { id: 38, level: 11, text: 'Ride the Wind (p.81)' },
        { id: 39, level: 17, text: 'River of Hungry Flame (p.81)' },
        { id: 40, level: 3, text: 'Rush of the Gale Spirits (p.81)' },
        { id: 41, level: 3, text: 'Shape the Flowing River (p.81)' },
        { id: 42, level: 3, text: 'Sweeping Cinder Strike (p.81)' },
        { id: 43, level: 3, text: 'Water Whip (p.81)' },
        { id: 44, level: 17, text: 'Wave of Rolling Earth (p.81)' },
      ],
      armorProficiencies: [],
      weaponProficiencies: {
        categories: [0],
    ...
    },
    {
      ...
      features: [
        ...
        // Oath of Devotion
        { id: 13, level: 3, text: 'CD: Sacred Weapon (p.86)' },
        { id: 14, level: 3, text: 'CD: Turn the Unholy (p.86)' },
        { id: 15, level: 7, text: 'Aura of Devotion (p.86)' },
        { id: 16, level: 18, text: 'Aura of Devotion (p.86)', replaces: 15 },
        { id: 17, level: 15, text: 'Purity of Spirit (p.86)' },
        { id: 18, level: 20, text: 'Holy Nimbus (p.86)' },
        // Oath of the Ancients
        { id: 19, level: 3, text: 'CD: Nature\'s Wrath (p.87)' },
        { id: 20, level: 3, text: 'CD: Turn the Faithless (p.87)' },
        { id: 21, level: 7, text: 'Aura of Warding (p.87)' },
        { id: 22, level: 18, text: 'Aura of Warding (p.87)', replaces: 21 },
        { id: 23, level: 15, text: 'Undying Sentinel (p.87)' },
        { id: 24, level: 20, text: 'Elder Champion (p.87)' },
        // Oath of Vengeance
        { id: 25, level: 3, text: 'CD: Abjure Enemy (p.88)' },
        { id: 26, level: 3, text: 'CD: Vow of Emnity (p.88)' },
        { id: 27, level: 7, text: 'Relentless Avenger (p.88)' },
        { id: 28, level: 15, text: 'Soul of Vengeance (p.88)' },
        { id: 29, level: 20, text: 'Avenging Angel (p.88)' },
      ],
      armorProficiencies: [0, 1, 2, 3],
      weaponProficiencies: {
        categories: [0, 1],
    ...
    },
    {
      ...
      features: [
        ...
        // Hunter
        { id: 10, level: 3, text: 'Hunter\'s Prey (p.93)' },
        { id: 11, level: 7, text: 'Defensive Tactics (p.93)' },
        { id: 12, level: 11, text: 'Multiattack (p.93)' },
        { id: 13, level: 15, text: 'Superior Hunter\'s Defense (p.93)' },
        // Beast Master
        { id: 14, level: 3, text: 'Ranger\'s Companion (p.93)' },
        { id: 15, level: 7, text: 'Exceptional Training (p.93)' },
        { id: 16, level: 11, text: 'Bestial Fury (p.93)' },
        { id: 17, level: 15, text: 'Share Spells (p.93)' },
      ],
      armorProficiencies: [0, 1, 3],
      weaponProficiencies: {
        categories: [0, 1],
    ...
    },
    {
      ...
      features: [
        ...
        // Thief
        { id: 11, level: 3, text: 'Fast Hands (p.97)' },
        { id: 12, level: 3, text: 'Second-Story Work (p.97)' },
        { id: 13, level: 9, text: 'Supreme Sneak (p.97)' },
        { id: 14, level: 13, text: 'Use Magic Device (p.97)' },
        { id: 15, level: 17, text: 'Thief\'s Reflexes (p.97)' },
        // Assassin
        { id: 16, level: 3, text: 'Bonus Proficiencies: Disguise Kit & Poisoner\'s Kit (p.97)' },
        { id: 17, level: 3, text: 'Assassinate (p.97)' },
        { id: 18, level: 9, text: 'Infiltration Expertise (p.97)' },
        { id: 19, level: 13, text: 'Impostor (p.97)' },
        { id: 20, level: 17, text: 'Death Strike (p.97)' },
        // Arcane Trickster
        { id: 21, level: 3, text: 'Mage Hand Lederdemain (p.98)' },
        { id: 22, level: 9, text: 'Magical Ambush (p.98)' },
        { id: 23, level: 13, text: 'Versatile Trickster (p.98)' },
        { id: 24, level: 17, text: 'Spell Thief (p.98)' },
      ],
      armorProficiencies: [0],
      weaponProficiencies: {
        categories: [0],
    ...
    },
    {
      ...
      features: [
        ...
        // Draconic Bloodline
        { id: 5, level: 1, text: 'Dragon Ancestor (p.102)' },
        { id: 6, level: 1, text: 'Draconic Resilience (p.102)' },
        { id: 7, level: 6, text: 'Elemental Affinity (p.102)' },
        { id: 8, level: 14, text: 'Dragon Wings (p.103)' },
        { id: 9, level: 18, text: 'Draconic Presence (p.103)' },
        // Wild Magic
        { id: 10, level: 1, text: 'Wild Magic Surge (p.103)' },
        { id: 11, level: 1, text: 'Tides of Chaos (p.103)' },
        { id: 12, level: 6, text: 'Bend Luck (p.103)' },
        { id: 13, level: 14, text: 'Controlled Chaos (p.103)' },
        { id: 14, level: 18, text: 'Spell Bombardment (p.103)' },
      ],
      armorProficiencies: [],
      weaponProficiencies: {
        categories: [],
    ...
    },
    {
      ...
      features: [
        ...
        // Archfey
        { id: 5, level: 1, text: 'Fey Presence (p.109)' },
        { id: 6, level: 6, text: 'Misty Escape (p.109)' },
        { id: 7, level: 10, text: 'Beguiling Defenses (p.109)' },
        { id: 8, level: 14, text: 'Dark Delirium (p.109)' },
        // Fiend
        { id: 9, level: 1, text: 'Dark One\'s Blessing (p.109)' },
        { id: 10, level: 6, text: 'Dark One\'s Own Luck (p.109)' },
        { id: 11, level: 10, text: 'Fiendish Resilience (p.109)' },
        { id: 12, level: 14, text: 'Hurl Through Hell (p.109)' },
        // Great Old One
        { id: 13, level: 1, text: 'Awakened Mind (p.110)' },
        { id: 14, level: 6, text: 'Entropic Ward (p.110)' },
        { id: 15, level: 10, text: 'Thought Shield (p.110)' },
        { id: 16, level: 14, text: 'Create Thrall (p.110)' },
      ],
      armorProficiencies: [0],
      weaponProficiencies: {
        categories: [0],
    ...
    },
    {
      ...
      features: [
        ...
        // Abjuration
        { id: 4, level: 2, text: 'Abjuration Savant (p.115)' },
        { id: 5, level: 2, text: 'Arcane Ward (p.115)' },
        { id: 6, level: 6, text: 'Projected Ward (p.115)' },
        { id: 7, level: 10, text: 'Improved Abjuration (p.115)' },
        { id: 8, level: 14, text: 'Spell Resistance (p.116)' },
        // Conjuration
        { id: 9, level: 2, text: 'Conjuration Savant (p.116)' },
        { id: 10, level: 2, text: 'Minor Conjuration (p.116)' },
        { id: 11, level: 6, text: 'Benign Transposition (p.116)' },
        { id: 12, level: 10, text: 'Focused Conjuration (p.116)' },
        { id: 13, level: 14, text: 'Durable Summons (p.116)' },
        // Divination
        { id: 14, level: 2, text: 'Divination Savant (p.116)' },
        { id: 15, level: 2, text: 'Portent (p.116)' },
        { id: 16, level: 6, text: 'Expert Divination (p.116)' },
        { id: 17, level: 10, text: 'The Third Eye (p.116)' },
        { id: 18, level: 14, text: 'Greater Portent (p.117)' },
        // Enchantment
        { id: 19, level: 2, text: 'Enchantment Savant (p.117)' },
        { id: 20, level: 2, text: 'Hypnotic Gaze (p.117)' },
        { id: 21, level: 6, text: 'Instinctive Charm (p.117)' },
        { id: 22, level: 10, text: 'Split Enchantment (p.117)' },
        { id: 23, level: 14, text: 'Alter Memories (p.117)' },
        // Evocation
        { id: 24, level: 2, text: 'Evocation Savant (p.117)' },
        { id: 25, level: 2, text: 'Sculpt Spells (p.117)' },
        { id: 26, level: 6, text: 'Potent Cantrip (p.117)' },
        { id: 27, level: 10, text: 'Empowered Evocation (p.117)' },
        { id: 28, level: 14, text: 'Overchannel (p.118)' },
        // Illusion
        { id: 29, level: 2, text: 'Illusion Savant (p.118)' },
        { id: 30, level: 2, text: 'Improved Minor Illusion (p.118)' },
        { id: 31, level: 6, text: 'Malleable Illusions (p.118)' },
        { id: 32, level: 10, text: 'Illusory Self (p.118)' },
        { id: 33, level: 14, text: 'Illusory Reality (p.118)' },
        // Necromancy
        { id: 34, level: 2, text: 'Necromancy Savant (p.118)' },
        { id: 35, level: 2, text: 'Grim Harvest (p.118)' },
        { id: 36, level: 6, text: 'Undead Thralls (p.119)' },
        { id: 37, level: 10, text: 'Inured to Undeath (p.119)' },
        { id: 38, level: 14, text: 'Command Undead (p.119)' },
        // Transmutation
        { id: 39, level: 2, text: 'Transmutation Savant (p.119)' },
        { id: 40, level: 2, text: 'Minor Alchemy (p.119)' },
        { id: 41, level: 6, text: 'Transmuter\'s Stone (p.119)' },
        { id: 42, level: 10, text: 'Shapechanger (p.119)' },
        { id: 43, level: 14, text: 'Master Transmuter (p.119)' },
      ],
      armorProficiencies: [],
      weaponProficiencies: {
        categories: [0],
